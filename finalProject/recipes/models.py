...
class Recipe(models.Model):
    ...
    avg_starts = models.IntegerField(blank = True, validators=[validate_max])
    recipe_comments = models.ForeignKey('comments.Comment', related_name='recipe_comments', on_delete=models.CASCADE, blank = True)
